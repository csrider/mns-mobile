...
}, '3.4.1', {requires: ['slider-base', 'graphics', 'node']});

// Create a new slider value range that supports an array of possible values
YUI.add('slider-array-range', function(Y) {
